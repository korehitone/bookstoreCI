                                ...
                                <td>
                                    <div class="d-flex gap-2">
                                        <button
                                            ...
                                            onclick="fillEditModal(<?= htmlspecialchars(json_encode($category)) ?>)"
                                        >
        ...
        <div class="modal-content border-0 shadow-lg rounded-4">
            <form action="<?= base_url('admin/categories/store') ?>" method="post">
                ...
                <div class="modal-footer border-0 pt-0">
                    ...
                    <button type="submit" class="btn btn-primary rounded-3 px-4">Save Category</button>
                </div>
            </form>
        </div>
    </div>
...
<div class="modal fade" id="deleteConfirmModal" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content border-0 shadow-lg rounded-4">
            ...
            <div class="modal-footer border-0 pt-0">
                <button type="button" class="btn btn-light rounded-3" data-bs-dismiss="modal">Cancel</button>
                <form action="<?= base_url('admin/categories/delete') ?>" method="post" id="deleteForm" style="display: inline;">
                    <?= csrf_field() ?>
