                                    ...
                                    <div class="bg-light rounded d-flex align-items-center justify-content-center border" style="width: 60px; height: 80px; overflow: hidden;">
                                        <?php if (!empty($book['img_url'])): ?>
                                            <img 
                                                ...
                                                class="img-fluid" 
                                                style="object-fit: cover; width: 60px; height: 80px;" 
                                                alt="cover"
                                            >
                                        <?php else: ?>
...
<div class="modal fade" id="addBookModal" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content border-0 shadow-lg rounded-4">
            <form action="<?= base_url('admin/books/store') ?>" method="post" enctype="multipart/form-data" novalidate>
                <?= csrf_field() ?>
                ...
                <div class="modal-body px-4 pb-4">
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" name="author" class="form-control rounded-2" required>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-6 mb-3">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" name="publisher" class="form-control rounded-2">
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            <label class="form-label fw-semibold">Release Date</label>
                            <input type="date" name="release_date" class="form-control rounded-2">
                        </div>
                        <div class="col-md-6 mb-3">
                            <label class="form-label fw-semibold">Price (IDR)</label>
                            <input type="number" name="price" class="form-control rounded-2" min="0" required>
                        </div>
                    </div>
                    <div class="mb-3">
                        <label class="form-label fw-semibold">Synopsis</label>
                        <textarea name="sipnosis" class="form-control rounded-2" rows="3"></textarea>
                    </div>
                    <div class="mb-3">
                        <label class="form-label fw-semibold">Cover Image</label>
                        <input type="file" name="image" class="form-control rounded-2" accept="image/*">
                    </div>
                </div>
                <div class="modal-footer border-0 pt-0">
                    <button type="button" class="btn btn-light rounded-2" data-bs-dismiss="modal">Cancel</button>
                    <button type="submit" class="btn btn-primary rounded-2 px-4">Save Book</button>
                </div>
            </form>
        </div>
    </div>
...
<div class="modal fade" id="editBookModal" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content border-0 shadow-lg rounded-4">
            <form action="" method="post" enctype="multipart/form-data" id="editBookForm" novalidate>
                <?= csrf_field() ?>
                <div class="modal-header border-0 pb-0">
                ...
                <div class="modal-body px-4 pb-4">
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            <label class="form-label fw-semibold">Title</label>
                            <input type="text" name="title" id="edit_title" class="form-control rounded-2" required>
                        </div>
                        <div class="col-md-6 mb-3">
                            <label class="form-label fw-semibold">Author</label>
                            <input type="text" name="author" id="edit_author" class="form-control rounded-2" required>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            <label class="form-label fw-semibold">Category</label>
                            <select name="category_id" id="edit_category_id" class="form-select rounded-2">
                                <option value="">— Select Category —</option>
                                <?php foreach ($navCategories as $cat): ?>
                                    <option value="<?= $cat['id'] ?>"><?= esc($cat['name']) ?></option>
                                <?php endforeach; ?>
                        ...
                        <div class="col-md-6 mb-3">
                            <label class="form-label fw-semibold">Publisher</label>
                            <input type="text" name="publisher" id="edit_publisher" class="form-control rounded-2">
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            <label class="form-label fw-semibold">Release Date</label>
                            <input type="date" name="release_date" id="edit_release_date" class="form-control rounded-2">
                        </div>
                        <div class="col-md-6 mb-3">
                            <label class="form-label fw-semibold">Price (IDR)</label>
                            <input type="number" name="price" id="edit_price" class="form-control rounded-2" min="0" required>
                        </div>
                    </div>
                    <div class="mb-3">
                        <label class="form-label fw-semibold">Synopsis</label>
                        <textarea name="sipnosis" id="edit_sipnosis" class="form-control rounded-2" rows="3"></textarea>
                    </div>
                    <div class="mb-3">
                        <label class="form-label fw-semibold">Cover Image</label>
                        <input type="file" name="image" class="form-control rounded-2" accept="image/*">
                ...
                <div class="modal-footer border-0 pt-0">
                    <button type="button" class="btn btn-light rounded-2" data-bs-dismiss="modal">Cancel</button>
                    <button type="submit" class="btn btn-primary rounded-2 px-4">Update Book</button>
                </div>
            </form>
        </div>
    </div>
...
<div class="modal fade" id="deleteConfirmModal" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content border-0 shadow-lg rounded-4">
            ...
            <div class="modal-footer border-0 pt-0">
                <button type="button" class="btn btn-light rounded-2" data-bs-dismiss="modal">Cancel</button>
                <button type="button" class="btn btn-danger rounded-2 px-4" onclick="confirmDeleteBook()">Delete</button>
            </div>
        </div>
    </div>
</div>
...
<script>
    ...
    /**
     * Set delete book ID and title for confirmation modal
     */
