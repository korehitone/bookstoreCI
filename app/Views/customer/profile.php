...
<div class="container">
                    ...
                    <div class="row g-4">
                        <div class="col-12">
                            <div class="d-flex align-items-start gap-3 p-3 bg-light rounded-3">
                                ...
                                <div class="flex-grow-1">
                                    ...
                                    <p class="fw-semibold mb-0"><?= $user['user_name'] ?></p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-12">
                            <div class="d-flex align-items-start gap-3 p-3 bg-light rounded-3">
                                ...
                                <div class="flex-grow-1">
                                    ...
                                    <p class="fw-semibold mb-0"><?= $user['user_email'] ?></p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-12">
                            <div class="d-flex align-items-start gap-3 p-3 bg-light rounded-3">
                                <div class="bg-warning bg-opacity-10 rounded-circle p-2">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" class="bi bi-geo-alt-fill text-warning" viewBox="0 0 16 16">
                                        <path d="M8 16s6-5.686 6-10A6 6 0 0 0 2 6c0 4.314 6 10 6 10zm0-7a3 3 0 1 1 0-6 3 3 0 0 1 0 6z" />
                                    </svg>
                                </div>
                                <div class="flex-grow-1">
                                    <p class="text-muted small mb-1">Address</p>
                                    <p class="fw-semibold mb-0"><?= !empty($user['user_address']) ? $user['user_address'] : 'The address has not been set' ?></p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-12">
                            <div class="d-flex gap-2 flex-wrap">
                                ...
                                <button class="btn btn-warning btn-sm px-3" data-bs-toggle="modal" data-bs-target="#changePasswordModal">
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content border-0 shadow-lg rounded-4">
                ...
                <div class="modal-body px-4 pb-4">
                    ...
                    <div class="mb-3">
                        <label for="
                            editUsername" class="form-label fw-semibold">Username</label>
                        <input type="text" class="form-control rounded-3" name="editUsername" id="editUsername" value="<?= $user['user_name']  ?>" required>
                    </div>

                    <div class="mb-3">
                        <label for="editEmail" class="form-label fw-semibold">Email</label>
                        <input type="email" class="form-control rounded-3" name="editEmail" id="editEmail" value="<?= $user['user_email'] ?>" readonly>
                    </div>
            ...
            <div class="modal-content border-0 shadow-lg rounded-4">
                ...
                <div class="modal-body px-4 pb-4">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="password" class="form-control <?= ($validation->hasError('currentPassword')) ? 'is-invalid' : '' ?> rounded-3"
                            name="currentPassword" id="currentPassword" placeholder="Enter current password" value="<?= (!($validation->hasError('currentPassword')) ? set_value('currentPassword') : '') ?>">
                        <?php if ($validation->getError('currentPassword')): ?>
                            <div class=" invalid-feedback">
                                <?= $validation->showError('currentPassword'); ?>
                            </div>
                        <?php endif; ?>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="password" class="form-control <?= ($validation->hasError('newPassword')) ? 'is-invalid' : '' ?> rounded-3"
                            name="newPassword" id="newPassword" placeholder="Enter new password" value="<?= (!($validation->hasError('newPassword')) ? set_value('newPassword') : '') ?>">
                        <?php if ($validation->getError('newPassword')): ?>
                            <div class=" invalid-feedback">
                                <?= $validation->showError('newPassword'); ?>
                            </div>
                        <?php endif; ?>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="password" class="form-control rounded-3 <?= ($validation->hasError('confirmNewPassword')) ? 'is-invalid' : '' ?>"
                            name="confirmNewPassword" id="confirmNewPassword" placeholder="Confirm new password" value="<?= (!($validation->hasError('confirmNewPassword')) ? set_value('confirmNewPassword') : '') ?>">
                        <?php if ($validation->getError('confirmNewPassword')): ?>
                            <div class=" invalid-feedback">
                                <?= $validation->showError('confirmNewPassword'); ?>
                            </div>
                        <?php endif; ?>
                    </div>
                ...
                <div class="modal-footer border-0 pt-0">
                    <button type="button" class="btn btn-light rounded-3 px-4" data-bs-dismiss="modal">Cancel</button>
                    <button type="submit" class="btn btn-warning rounded-3 px-4">Update Password</button>
                </div>
                <?= form_close(); ?>
            </div>
        </div>
            ...
            <div class="modal-content border-0 shadow-lg rounded-4">
                ...
                <div class="modal-body px-4 pb-4">
                    ...
                    <div class="text-center my-3">
                        ...
                        <p class="text-muted small mb-0 mt-2">This action cannot be undone and all your data will be permanently removed.</p>
                    </div>
                </div>
                <div class="modal-footer border-0 pt-0">
                    <button type="button" class="btn btn-light rounded-3 px-4" data-bs-dismiss="modal">Cancel</button>
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            <?php if ($validation->hasError('currentPassword') || $validation->hasError('newPassword') || $validation->hasError('confirmNewPassword')): ?>
